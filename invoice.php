...
<body>
  <div class="container">
    <div class="row">
      <div class="col col-md-12 tengah">
        <p>
        <span style="font-family: 'Lobster', cursive; font-size: 40px; color: red;"> OPLSHOP</span>
        <span id="cetak"><a href="" onclick="window.print()"><img src="img/cetak.png" alt="" width=30px></a></span><br>
        Jl. Salemba Tengah No. 152C Jakarta Pusat <br>
        Telepon : (021) 3915957 <br>
        </p><hr>
      </div>
    </div>
      <?php
