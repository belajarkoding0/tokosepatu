    ...
    <table class="table table-striped">
      <thead class="thead-dark">
        <tr>
          ...
          <th scope="col" class="kanan">Total</th>
        </tr>
      </thead>
      <tbody>
    ...
    <br>
      <div class="col-sm-6 col-sm-soffset-3">
        ...
        <div class="text-scenter">
          <p>Jika sudah melakukan pembayaran, silahkan klik <a href="konfirmasi.php">disini</a> untuk konfirmasi</p>
        </div>
      </div>
    </div>
  </div>
